  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-50">
      <div className="bg-white shadow-lg rounded-xl p-8 flex flex-col items-center text-center max-w-sm">
        {/* Optional icon */}
        <RefreshCw className="w-12 h-12 text-red-400 mb-4 animate-spin-slow" />
        ...
        <button
          ...
          className="flex items-center gap-2 bg-red-500 hover:bg-red-600 text-white font-semibold px-5 py-2 rounded-lg shadow-md transition duration-200"
        >
